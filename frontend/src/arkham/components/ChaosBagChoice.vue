    ...
    <div class="token-choices-inner">
      <div v-for="(tokenChoice, idx) in tokenChoices" :key="idx" class="token-choice" :class="{ 'token-choice-multi': tokenChoice.tag === 'Resolved' && tokenChoice.tokens.length > 1 }">
        ...
        <template v-else-if="'step' in tokenChoice && tokenChoice.step.tag === 'Draw'">
          <img :src="imgsrc('chaos-tokens/ct-blank.png')" class="token" v-if="tokenChoice.tag === 'Decided'" />
          <img :src="imgsrc('chaos-tokens/ct-blank.png')" class="token deciding" v-if="tokenChoice.tag === 'Deciding'" />
          <img :src="imgsrc('chaos-tokens/ct-choose.png')" class="token" v-if="tokenChoice.tag === 'Undecided'" />
        </template>
        ...
        <template v-else-if="tokenChoice.tag === 'Draw'">
          <img :src="imgsrc('chaos-tokens/ct-blank.png')" class="token" />
        </template>
