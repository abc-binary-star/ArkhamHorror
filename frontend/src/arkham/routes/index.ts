...
export default [
  ...
  },
  {
    path: '/games/:gameId',
    name: 'Game',
    component: () => import('@/arkham/views/GameTabletop.vue'),
    meta: { requiresAuth: true, title: "Arkham Horror", hideNav: true },
    props: true,
  },
  {
  ...
  },
  {
    ...
    name: 'Spectate',
    component: () => import('@/arkham/views/GameTabletop.vue'),
    meta: { requiresAuth: true, title: "Arkham Horror: Spectate", hideNav: true },
    props: (route: RouteLocationNormalized) => ({ ...route.params, spectate: true }),
  },
  {
