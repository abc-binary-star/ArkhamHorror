module Arkham.Scenario.Scenarios.EdgeOfTheEarth.ToTheForbiddenPeaks (toTheForbiddenPeaks) where

import Arkham.Act.CardDefs.EdgeOfTheEarth.ToTheForbiddenPeaks qualified as Acts
