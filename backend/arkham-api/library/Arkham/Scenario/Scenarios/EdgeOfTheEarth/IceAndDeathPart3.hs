module Arkham.Scenario.Scenarios.EdgeOfTheEarth.IceAndDeathPart3 (iceAndDeathPart3) where

import Arkham.Act.CardDefs.EdgeOfTheEarth.IceAndDeath qualified as Acts
